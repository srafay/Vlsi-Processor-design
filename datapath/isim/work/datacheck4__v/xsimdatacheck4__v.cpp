...
va_list vap)
{
    extern HSim__s6 * createworkMdatacheck4__v(const char*);
    HSim__s6 *blk = createworkMdatacheck4__v(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("datacheck4_v", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMdatacheck4__v(const char*);
        topvl = (HSim__s5*)createworkMdatacheck4__v("datacheck4_v");
