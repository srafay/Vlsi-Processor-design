...
va_list vap)
{
    extern HSim__s6 * createworkMdatacheck__v(const char*);
    HSim__s6 *blk = createworkMdatacheck__v(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("datacheck_v", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMdatacheck__v(const char*);
        topvl = (HSim__s5*)createworkMdatacheck__v("datacheck_v");
