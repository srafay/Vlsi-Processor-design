...
va_list vap)
{
    extern HSim__s6 * createworkMchecck__v(const char*);
    HSim__s6 *blk = createworkMchecck__v(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("checck_v", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMchecck__v(const char*);
        topvl = (HSim__s5*)createworkMchecck__v("checck_v");
