...
va_list vap)
{
    extern HSim__s6 * createworkMdatacheck3__v(const char*);
    HSim__s6 *blk = createworkMdatacheck3__v(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("datacheck3_v", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMdatacheck3__v(const char*);
        topvl = (HSim__s5*)createworkMdatacheck3__v("datacheck3_v");
