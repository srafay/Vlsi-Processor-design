...
va_list vap)
{
    extern HSim__s6 * createworkMcheck__v(const char*);
    HSim__s6 *blk = createworkMcheck__v(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("check_v", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMcheck__v(const char*);
        topvl = (HSim__s5*)createworkMcheck__v("check_v");
